    ...
    <main class="mt-5">
        <div class="block md:flex md:space-x-2 px-2 lg:p-0">
            ...
            >
                ...
                <img src="https://nearshoreamericas.com/wp-content/uploads/2021/01/amberrr.jpg" class="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
            ...
            >
                <div class="absolute left-0 top-0 w-full h-full z-10"
                     style="background-image: linear-gradient(180deg,transparent,rgba(0,0,0,.7));"></div>
                <img src="https://our.today/wp-content/uploads/2021/09/Dushyant-Savadia-Headshots-.jpg" class="absolute w-full h-full rounded z-0 object-contain object-center" />
                <div class="p-4 absolute bottom-0 left-0 z-20">
                    <span class="px-4 py-1 bg-black text-gray-200 inline-flex items-center justify-center mb-2">Amber Group Limited Founder & CEO</span>
                    <h2 class="text-3xl font-semibold text-gray-100 leading-tight">Dushant Savadia</h2>
        ...
        <div class="block lg:flex lg:space-x-2 px-2 lg:p-0 mt-10 mb-10">
            ...
            <div class="w-full lg:w-2/3">
                ...
                <a
                    class="mb-4 md:mb-10 w-full md:w-full relative rounded inline-block"
                    style="height: 24em;"
                    href="./blog.html"
                >
                    <div class="absolute left-0 bottom-0 w-full h-full z-10"
                         style="background-image: linear-gradient(180deg,transparent,rgba(0,0,0,.7));"></div>
                    <img src="https://moey.gov.jm/wp-content/uploads/2021/02/IMG-20210222-WA0013.jpg" class="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
                    <div class="p-4 absolute bottom-0 left-0 z-20">
                        <span class="px-4 py-1 bg-black text-gray-200 inline-flex items-center justify-center mb-2">Nutrition</span>
                        <h2 class="text-4xl font-semibold text-gray-100 leading-tight">
                            Pellentesque a consectetur velit, ac molestie ipsum. Donec sodales, massa et auctor.
                ...
                <div class="rounded w-full lg:flex mb-10">
                    <div class="h-48 lg:w-48 flex-none bg-cover text-center overflow-hidden opacity-75"
                         style="background-image: url('https://i.ytimg.com/vi/DBOCptlNAUs/maxresdefault.jpg')" title="deit is very important">
                    </div>
                ...
                <div class="rounded w-full lg:flex mb-10">
                    <div class="h-48 lg:w-48 flex-none bg-cover text-center overflow-hidden opacity-75"
                         style="background-image: url('https://source.unsplash.com/random')" title="deit is very important">
                    </div>
                    <div class="bg-white rounded px-4 flex flex-col justify-between leading-normal">
                        <div>
                            <div class="mt-3 md:mt-0 text-gray-700 font-bold text-2xl mb-2">
